...
#
# Generated by export_simulation on Fri Mar 13 16:20:45 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './mean_data_cmpy_1.sh' script.

./mean_data_cmpy_1.sh -reset_run
...
./mean_data_cmpy_1.sh -noclean_files

For more information on the script, please type './mean_data_cmpy_1.sh -help'.
