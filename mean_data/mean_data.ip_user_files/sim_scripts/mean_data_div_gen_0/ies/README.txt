...
#
# Generated by export_simulation on Fri Mar 13 20:55:40 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './mean_data_div_gen_0.sh' script.

./mean_data_div_gen_0.sh -reset_run
...
./mean_data_div_gen_0.sh -noclean_files

For more information on the script, please type './mean_data_div_gen_0.sh -help'.
