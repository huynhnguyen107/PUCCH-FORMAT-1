...
#
# Generated by export_simulation on Thu Mar 12 20:31:04 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './mean_data_fifo0.sh' script.

./mean_data_fifo0.sh -reset_run
...
./mean_data_fifo0.sh -noclean_files

For more information on the script, please type './mean_data_fifo0.sh -help'.
