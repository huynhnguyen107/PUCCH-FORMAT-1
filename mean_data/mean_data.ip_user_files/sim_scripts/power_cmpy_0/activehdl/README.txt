...
#
# Generated by export_simulation on Fri Mar 13 17:19:57 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './power_cmpy_0.sh' script.

./power_cmpy_0.sh -reset_run
...
./power_cmpy_0.sh -noclean_files

For more information on the script, please type './power_cmpy_0.sh -help'.
