...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_16 -L cmpy_v6_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot c1_cmpy xil_defaultlib.c1_cmpy -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim c1_cmpy -key {Behavioral:sim_1:Functional:c1_cmpy} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb c1_cmpy.wdb xsim.dir)
