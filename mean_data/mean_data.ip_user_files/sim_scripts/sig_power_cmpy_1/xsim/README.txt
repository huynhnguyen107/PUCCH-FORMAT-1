...
#
# Generated by export_simulation on Thu Mar 12 15:38:56 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './sig_power_cmpy_1.sh' script.

./sig_power_cmpy_1.sh -reset_run
...
./sig_power_cmpy_1.sh -noclean_files

For more information on the script, please type './sig_power_cmpy_1.sh -help'.
