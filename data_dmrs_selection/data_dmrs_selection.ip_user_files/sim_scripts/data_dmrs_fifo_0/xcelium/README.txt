...
#
# Generated by export_simulation on Mon Mar 16 17:26:53 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './data_dmrs_fifo_0.sh' script.

./data_dmrs_fifo_0.sh -reset_run
...
./data_dmrs_fifo_0.sh -noclean_files

For more information on the script, please type './data_dmrs_fifo_0.sh -help'.
