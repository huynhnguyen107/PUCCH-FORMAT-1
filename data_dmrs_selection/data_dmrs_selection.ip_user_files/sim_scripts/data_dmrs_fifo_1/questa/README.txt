...
#
# Generated by export_simulation on Mon Mar 16 17:27:14 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './data_dmrs_fifo_1.sh' script.

./data_dmrs_fifo_1.sh -reset_run
...
./data_dmrs_fifo_1.sh -noclean_files

For more information on the script, please type './data_dmrs_fifo_1.sh -help'.
