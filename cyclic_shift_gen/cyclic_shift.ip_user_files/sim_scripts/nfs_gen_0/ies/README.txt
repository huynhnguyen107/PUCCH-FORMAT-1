...
#
# Generated by export_simulation on Sat Feb 28 19:19:23 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './nfs_gen_0.sh' script.

./nfs_gen_0.sh -reset_run
...
./nfs_gen_0.sh -noclean_files

For more information on the script, please type './nfs_gen_0.sh -help'.
