...
#
# Generated by export_simulation on Wed Mar 04 21:08:29 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './cyclic_gen.sh' script.

./cyclic_gen.sh -reset_run
...
./cyclic_gen.sh -noclean_files

For more information on the script, please type './cyclic_gen.sh -help'.
