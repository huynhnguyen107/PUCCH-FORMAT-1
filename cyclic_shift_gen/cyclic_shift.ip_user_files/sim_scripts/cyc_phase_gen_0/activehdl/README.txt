...
#
# Generated by export_simulation on Tue Dec 30 00:46:50 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './cyc_phase_gen_0.sh' script.

./cyc_phase_gen_0.sh -reset_run
...
./cyc_phase_gen_0.sh -noclean_files

For more information on the script, please type './cyc_phase_gen_0.sh -help'.
