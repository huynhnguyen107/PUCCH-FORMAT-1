...
#
# Generated by export_simulation on Thu Feb 26 16:02:28 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './ba_se_1.sh' script.

./ba_se_1.sh -reset_run
...
./ba_se_1.sh -noclean_files

For more information on the script, please type './ba_se_1.sh -help'.
