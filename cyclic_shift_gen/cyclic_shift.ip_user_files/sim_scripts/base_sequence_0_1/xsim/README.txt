...
#
# Generated by export_simulation on Tue Dec 30 00:46:19 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './base_sequence_0.sh' script.

./base_sequence_0.sh -reset_run
...
./base_sequence_0.sh -noclean_files

For more information on the script, please type './base_sequence_0.sh -help'.
