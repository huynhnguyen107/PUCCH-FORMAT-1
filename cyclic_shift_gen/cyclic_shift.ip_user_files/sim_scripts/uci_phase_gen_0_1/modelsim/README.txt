...
#
# Generated by export_simulation on Thu Feb 26 15:50:11 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './uci_phase_gen_0.sh' script.

./uci_phase_gen_0.sh -reset_run
...
./uci_phase_gen_0.sh -noclean_files

For more information on the script, please type './uci_phase_gen_0.sh -help'.
