...
#
# Generated by export_simulation on Tue Dec 30 00:47:43 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './cyclic_cmpy_0.sh' script.

./cyclic_cmpy_0.sh -reset_run
...
./cyclic_cmpy_0.sh -noclean_files

For more information on the script, please type './cyclic_cmpy_0.sh -help'.
