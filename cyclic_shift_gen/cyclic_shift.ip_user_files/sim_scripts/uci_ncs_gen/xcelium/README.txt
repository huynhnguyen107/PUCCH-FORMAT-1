...
#
# Generated by export_simulation on Thu Feb 26 15:53:03 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './uci_ncs_gen.sh' script.

./uci_ncs_gen.sh -reset_run
...
./uci_ncs_gen.sh -noclean_files

For more information on the script, please type './uci_ncs_gen.sh -help'.
