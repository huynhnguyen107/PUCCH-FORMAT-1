...
#
# Generated by export_simulation on Tue Dec 30 00:47:21 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './cyclic_fifo_generator_0.sh' script.

./cyclic_fifo_generator_0.sh -reset_run
...
./cyclic_fifo_generator_0.sh -noclean_files

For more information on the script, please type './cyclic_fifo_generator_0.sh -help'.
