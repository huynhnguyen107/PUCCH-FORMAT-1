...
#
# Generated by export_simulation on Mon Mar 09 14:53:18 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './de_spread_cmpy_0.sh' script.

./de_spread_cmpy_0.sh -reset_run
...
./de_spread_cmpy_0.sh -noclean_files

For more information on the script, please type './de_spread_cmpy_0.sh -help'.
