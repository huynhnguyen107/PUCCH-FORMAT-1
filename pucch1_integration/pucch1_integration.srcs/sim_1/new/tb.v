...
module tb();
	...
	//read uci_param
	initial begin
		$readmemh("D:/FPGA/Vivaldo Project/PUCCH-FORMAT-1/TEST/case4/uci_param.mem", uci_param_mem);
	end
	// assign wire_pucch_parameter = (idx > 1) ? uci_param_mem[0] : 512'd0;
	assign wire_pucch_parameter = uci_param_mem[0];
	//read I, Q
	initial begin
	$readmemh("D:/FPGA/Vivaldo Project/PUCCH-FORMAT-1/TEST/case4/I.mem", I_mem);
	$readmemh("D:/FPGA/Vivaldo Project/PUCCH-FORMAT-1/TEST/case4/Q.mem", Q_mem);
	end
