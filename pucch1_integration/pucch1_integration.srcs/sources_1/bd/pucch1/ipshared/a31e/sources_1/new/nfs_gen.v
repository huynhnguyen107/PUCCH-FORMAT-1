	...
	always @(posedge clk) begin
		if (rst) begin
			...
			if (in_valid) begin
				...
				//no hopping
				//uci
				nfs_no_intra_uci_0 <= uci_nSymbs[3:1];
				nfs_no_intra_uci_1 <= uci_nSymbs[3:1];
				//dmrs
				nfs_no_intra_dmrs_0 <= uci_nSymbs[3:1] + uci_nSymbs[0];
				nfs_no_intra_dmrs_1 <= uci_nSymbs[3:1] + uci_nSymbs[0];
				//hopping
				//uci
