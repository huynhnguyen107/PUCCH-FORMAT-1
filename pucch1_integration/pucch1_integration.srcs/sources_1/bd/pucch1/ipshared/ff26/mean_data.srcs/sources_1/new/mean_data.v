...
module mean_data(
		...
		if (rst) begin
			...
			if (despread_dmrs_valid) begin
				...
				if (cnt_7_dmrs < reg_ndmrs_1st) begin
					total_dmrs_1[21:0] <= total_dmrs_1[21:0] + {{6{despread_dmrs[15]}}, despread_dmrs[15:0]} ;
					total_dmrs_1[43:22] <= total_dmrs_1[43:22] + {{6{despread_dmrs[31]}},despread_dmrs[31:16]} ;
				end
				else begin
					total_dmrs_2[21:0]  <= total_dmrs_2[21:0] + {{6{despread_dmrs[15]}}, despread_dmrs[15:0]} ;
					total_dmrs_2[43:22] <= total_dmrs_2[43:22] + {{6{despread_dmrs[31]}},despread_dmrs[31:16]} ;
				end
			...
			if (despread_uci_valid) begin
				...
				if (cnt_7_uci < reg_nuci_1st) begin
					total_uci_1[21:0] <= total_uci_1[21:0] + {{6{despread_uci[15]}}, despread_uci[15:0]} ;
					total_uci_1[43:22] <= total_uci_1[43:22] + {{6{despread_uci[31]}}, despread_uci[31:16]} ;
				end
				else begin
					total_uci_2[21:0]  <= total_uci_2[21:0] + {{6{despread_uci[15]}},despread_uci[15:0]} ;
					total_uci_2[43:22] <= total_uci_2[43:22] + {{6{despread_uci[31]}},despread_uci[31:16]} ;
				end
	...
	//assign noise[63:32] = {dmrs_1st_fifo[31:16], 16'd0} - d_mean_dmrs_1[63:32] + 32'd214748364; for simulation only
	assign noise[63:32] = {dmrs_1st_fifo[31:16], 16'd0} - d_mean_dmrs_1[63:32];
	//power noise
