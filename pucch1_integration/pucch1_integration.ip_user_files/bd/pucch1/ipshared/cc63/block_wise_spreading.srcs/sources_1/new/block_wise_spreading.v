...
module block_wise_spreading(
	...
	//select valid wise
	assign wise_valid= reg_intra_fr_hop ? wise_valid_0|wise_valid_1 : wise_valid_0;
	assign wise= reg_intra_fr_hop ? (wise_valid_0 ? wise_0: wise_1) : wise_0;
