...
#
# Generated by export_simulation on Wed Mar 18 20:12:44 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './pucch1.sh' script.
...
./pucch1.sh -noclean_files

For more information on the script, please type './pucch1.sh -help'.
