...
#
# Generated by export_simulation on Thu Jan 01 02:46:50 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './ctr_pre_fft_0.sh' script.

./ctr_pre_fft_0.sh -reset_run
...
./ctr_pre_fft_0.sh -noclean_files

For more information on the script, please type './ctr_pre_fft_0.sh -help'.
