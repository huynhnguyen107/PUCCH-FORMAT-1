...
#
# Generated by export_simulation on Wed Mar 18 22:26:41 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './spreading_cmpy_0.sh' script.

./spreading_cmpy_0.sh -reset_run
...
./spreading_cmpy_0.sh -noclean_files

For more information on the script, please type './spreading_cmpy_0.sh -help'.
