...
#
# Generated by export_simulation on Sat Dec 27 18:30:17 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './xcorr_cmpy_8.sh' script.

./xcorr_cmpy_8.sh -reset_run
...
./xcorr_cmpy_8.sh -noclean_files

For more information on the script, please type './xcorr_cmpy_8.sh -help'.
