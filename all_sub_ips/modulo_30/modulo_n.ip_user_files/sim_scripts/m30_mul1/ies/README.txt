...
#
# Generated by export_simulation on Tue Dec 30 01:43:00 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './m30_mul1.sh' script.

./m30_mul1.sh -reset_run
...
./m30_mul1.sh -noclean_files

For more information on the script, please type './m30_mul1.sh -help'.
