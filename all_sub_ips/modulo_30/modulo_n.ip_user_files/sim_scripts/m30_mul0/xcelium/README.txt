...
#
# Generated by export_simulation on Tue Dec 30 01:42:21 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './m30_mul0.sh' script.

./m30_mul0.sh -reset_run
...
./m30_mul0.sh -noclean_files

For more information on the script, please type './m30_mul0.sh -help'.
