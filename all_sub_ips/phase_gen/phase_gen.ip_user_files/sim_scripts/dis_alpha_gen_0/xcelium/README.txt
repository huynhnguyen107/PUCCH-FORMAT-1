...
#
# Generated by export_simulation on Wed Feb 25 18:23:19 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './dis_alpha_gen_0.sh' script.

./dis_alpha_gen_0.sh -reset_run
...
./dis_alpha_gen_0.sh -noclean_files

For more information on the script, please type './dis_alpha_gen_0.sh -help'.
