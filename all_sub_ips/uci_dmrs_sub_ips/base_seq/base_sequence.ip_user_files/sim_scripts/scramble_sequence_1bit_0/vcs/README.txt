...
#
# Generated by export_simulation on Wed Dec 24 23:16:12 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './scramble_sequence_1bit_0.sh' script.

./scramble_sequence_1bit_0.sh -reset_run
...
./scramble_sequence_1bit_0.sh -noclean_files

For more information on the script, please type './scramble_sequence_1bit_0.sh -help'.
