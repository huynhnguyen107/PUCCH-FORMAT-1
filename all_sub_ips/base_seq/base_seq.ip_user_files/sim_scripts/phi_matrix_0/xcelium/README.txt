...
#
# Generated by export_simulation on Mon Dec 29 23:24:19 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './phi_matrix_0.sh' script.

./phi_matrix_0.sh -reset_run
...
./phi_matrix_0.sh -noclean_files

For more information on the script, please type './phi_matrix_0.sh -help'.
