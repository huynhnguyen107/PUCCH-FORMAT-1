...
#
# Generated by export_simulation on Tue Mar 03 18:48:10 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './ba_seq_control_blk_0.sh' script.

./ba_seq_control_blk_0.sh -reset_run
...
./ba_seq_control_blk_0.sh -noclean_files

For more information on the script, please type './ba_seq_control_blk_0.sh -help'.
