...
#
# Generated by export_simulation on Sun Mar 01 19:19:03 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './base_se_control_blk_1.sh' script.

./base_se_control_blk_1.sh -reset_run
...
./base_se_control_blk_1.sh -noclean_files

For more information on the script, please type './base_se_control_blk_1.sh -help'.
