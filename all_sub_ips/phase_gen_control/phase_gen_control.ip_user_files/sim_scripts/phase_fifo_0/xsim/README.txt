...
#
# Generated by export_simulation on Wed Mar 04 19:05:17 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './phase_fifo_0.sh' script.

./phase_fifo_0.sh -reset_run
...
./phase_fifo_0.sh -noclean_files

For more information on the script, please type './phase_fifo_0.sh -help'.
