...
#
# Generated by export_simulation on Fri Mar 27 11:30:23 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './scra_seq_8_ncs_0.sh' script.

./scra_seq_8_ncs_0.sh -reset_run
...
./scra_seq_8_ncs_0.sh -noclean_files

For more information on the script, please type './scra_seq_8_ncs_0.sh -help'.
