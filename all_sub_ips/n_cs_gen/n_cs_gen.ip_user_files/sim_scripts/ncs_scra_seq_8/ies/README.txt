...
#
# Generated by export_simulation on Mon Feb 23 16:36:42 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './ncs_scra_seq_8.sh' script.

./ncs_scra_seq_8.sh -reset_run
...
./ncs_scra_seq_8.sh -noclean_files

For more information on the script, please type './ncs_scra_seq_8.sh -help'.
