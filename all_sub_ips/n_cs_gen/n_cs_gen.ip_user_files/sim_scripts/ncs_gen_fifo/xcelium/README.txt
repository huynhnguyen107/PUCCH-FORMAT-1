...
#
# Generated by export_simulation on Wed Feb 25 19:03:01 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './ncs_gen_fifo.sh' script.

./ncs_gen_fifo.sh -reset_run
...
./ncs_gen_fifo.sh -noclean_files

For more information on the script, please type './ncs_gen_fifo.sh -help'.
