...
#
# Generated by export_simulation on Wed Dec 24 16:55:08 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './mult_gen_dis_alpha.sh' script.

./mult_gen_dis_alpha.sh -reset_run
...
./mult_gen_dis_alpha.sh -noclean_files

For more information on the script, please type './mult_gen_dis_alpha.sh -help'.
