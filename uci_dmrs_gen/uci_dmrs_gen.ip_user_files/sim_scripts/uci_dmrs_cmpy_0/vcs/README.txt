...
#
# Generated by export_simulation on Sat Mar 07 18:34:56 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './uci_dmrs_cmpy_0.sh' script.

./uci_dmrs_cmpy_0.sh -reset_run
...
./uci_dmrs_cmpy_0.sh -noclean_files

For more information on the script, please type './uci_dmrs_cmpy_0.sh -help'.
