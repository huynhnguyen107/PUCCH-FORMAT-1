...
module uci_dmrs_gen(
	...
	input wise_valid_1,
	input [31:0] wise_1,
	output uci_dmrs_valid,
	output [31:0] uci_dmrs
    );
	...
	uci_dmrs_cmpy_0 uci_dmrs_cmpy_0 (
	  ...
	  .m_axis_dout_tvalid(uci_dmrs_valid),  // output wire m_axis_dout_tvalid
	  .m_axis_dout_tdata(m_axis_dout_tdata)    // output wire [79 : 0] m_axis_dout_tdata
	);
	//ouput
	assign uci_dmrs= {m_axis_dout_tdata[70:55], m_axis_dout_tdata[30:15] };
endmodule
