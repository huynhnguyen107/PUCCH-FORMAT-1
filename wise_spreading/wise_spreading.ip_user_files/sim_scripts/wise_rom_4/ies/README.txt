...
#
# Generated by export_simulation on Fri Mar 06 22:07:19 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './wise_rom_4.sh' script.

./wise_rom_4.sh -reset_run
...
./wise_rom_4.sh -noclean_files

For more information on the script, please type './wise_rom_4.sh -help'.
