...
#
# Generated by export_simulation on Fri Mar 06 21:07:33 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './wise_rom_3.sh' script.

./wise_rom_3.sh -reset_run
...
./wise_rom_3.sh -noclean_files

For more information on the script, please type './wise_rom_3.sh -help'.
